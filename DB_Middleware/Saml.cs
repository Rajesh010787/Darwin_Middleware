...
namespace Saml
{
	...
	public partial class Response1 
	{
		...
		public Response1(string certificateStr, string responseString)
			: this(StringToByteArray(certificateStr), responseString) { }

		public Response1(byte[] certificateBytes, string responseString) : this(certificateBytes)
		{
			LoadXmlFromBase64(responseString);
		}

		public Response1(string certificateStr) : this(StringToByteArray(certificateStr)) { }

		public Response1(byte[] certificateBytes)
		{
